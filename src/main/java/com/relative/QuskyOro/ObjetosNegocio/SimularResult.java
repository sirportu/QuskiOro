...
public class SimularResult implements java.io.Serializable {
	...
	public com.relative.QuskyOro.ObjetosNegocio.XmlVariablesInternasSalida getXmlVariablesInternas() {
		return this.xmlVariablesInternas;
	}

	public void setXmlVariablesInternas(
			com.relative.QuskyOro.ObjetosNegocio.XmlVariablesInternasSalida xmlVariablesInternas) {
